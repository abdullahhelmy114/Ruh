  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 md:px-8">
      ...
      <div className="glass rounded-3xl p-8 md:p-10 shadow-elegant space-y-8 text-sm leading-relaxed">
        <section>
          <h2 className="font-serif text-xl text-amber-600 mb-2"><T>1. Acceptance of Terms</T></h2>
        ...
        <section>
          <h2 className="font-serif text-xl text-amber-600 mb-2"><T>2. User Accounts</T></h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="font-serif text-xl text-amber-600 mb-2"><T>3. Payments & Refunds</T></h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="font-serif text-xl text-amber-600 mb-2"><T>4. Intellectual Property</T></h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="font-serif text-xl text-amber-600 mb-2"><T>5. Code of Conduct</T></h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="font-serif text-xl text-amber-600 mb-2"><T>6. Limitation of Liability</T></h2>
