  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 md:px-8">
      ...
      <div className="glass rounded-3xl p-8 md:p-10 shadow-elegant space-y-8 text-sm leading-relaxed">
        <section>
          <h2 className="font-serif text-xl text-accent-foreground mb-2"><T>1. Information We Collect</T></h2>
        ...
        <section>
          <h2 className="font-serif text-xl text-accent-foreground mb-2"><T>2. How We Use Your Data</T></h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="font-serif text-xl text-accent-foreground mb-2"><T>3. Data Storage & Protection</T></h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="font-serif text-xl text-accent-foreground mb-2"><T>4. Your Rights</T></h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="font-serif text-xl text-accent-foreground mb-2"><T>5. Cookies</T></h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="font-serif text-xl text-accent-foreground mb-2"><T>6. Contact Us</T></h2>
